    ...
    if ($jam) {
        ...
        if ($status == 'Masuk' && $jam > $jam_kerja->finish) {
            if ($raw) {
                ...
                return '<span class="badge badge-danger">' . $jam . " - Terlambat" . '</span>';
            }
            ...
            if ($raw) {
                ...
                return '<span class="badge badge-primary">' . $jam . " - On Time" . '</span>';
            }
            ...
            if ($raw) {
                ...
                return '<span class="badge badge-danger">' . $jam . " - Lebih Awal" . '</span>';
            }
        } else {
            if ($raw) {
                return [
