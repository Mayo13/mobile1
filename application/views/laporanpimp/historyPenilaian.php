        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Daftar Uraian Tugas</h3>
                </div>
                <div class="card-body">
                    <!-- form biodata -->
                                ...
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    <div class="form-group">
                                        <h4 class="card-title" style="color: red;">Catatan :<br>
                                            ...
                                            - Periode untuk pencetakan laporan yang dapat dicetak yaitu 60 hari dalam satu kali generate.
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table id="example3" class="table responive table-bordered table-striped">
                                <thead>
                                    <tr style="text-align: center;">
                                        ...
                                        <th style="vertical-align: middle; width: 25%;">Penilaian</th>
                                        <th style="vertical-align: middle; width: 25%;">Keterangan</th>
                                        <!-- <th style="vertical-align: middle; width: 25%;">Terselesaikan</th> -->
                                    </tr>
                                </thead>
                                <tbody id="show_data">
                                </tbody>
