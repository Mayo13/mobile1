    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-6">
                    <div class="info-box">
                        <span class="info-box-icon bg-primary elevation-1"><i class="fas fa-star-half-alt"></i></span>
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <div style="color:green">
                                    ...
                                    echo $belumKinerja;
                                    ?>
                                    <small>Orang sudah mendapatkan penilaian</small><br>
                                </div>
                                <div style="color:red">
                                    <?php
                                    echo $sudahKinerja;
                                    ?>
                                    <small>Orang belum mendapatkan penilaian</small>
                                </div>
                            </span>
                        </div>
                        <!-- /.info-box-content -->
                ...
                <div class="col-lg-6 col-sm-12 col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">PNASN Berdasarkan Jabatan</h3>
