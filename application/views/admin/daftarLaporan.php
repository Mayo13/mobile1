                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Daftar Pimpinan Pimpinan</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    foreach ($dataKtu as $data) {
                                        ...
                                        echo "<td>                                                      
                                                    <a href= '" . base_url() . "index.php/admin/daftarLaporanDetail/" . $urisafe . "' class='icon-block btn btn-primary'>
                                                    <i class='far fa-eye'></i>
                                                    <span>Daftar PNASN</span>
                                                    </a>                                                                                                                                                                                                                                              
                                                    </td>";
