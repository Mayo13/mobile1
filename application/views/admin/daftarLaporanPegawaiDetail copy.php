                        ...
                        <div class="card-body">
                            <div>
                                <div class="form-group">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text"><?php echo $dataPegawai[0]->nama_depan . " " . $dataPegawai[0]->nama_belakang ?></label></p>
                                                    </div>
                                                </div>
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h2 class="card-title"><b>NIK. </b></h2>
                                                        <p class="card-text"><?php echo $dataPegawai[0]->nik_pegawai  ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-12">
                                            <div class="card">
                                                <div class="card-body">
                                                    <h2 class="card-title"><b>Job Desk</b></h2>
                                                    <p class="card-text"><?php echo $dataPegawai[0]->jabatan  ?></p>
                                                </div>
                                            </div>
                                            <div class="card">
                                                <div class="card-body">
                                                    <h2 class="card-title"><b>Periode Kerja</b></h2>
                                                    <p class="card-text"><?php

                                                                            $time = strtotime($dataPegawai[0]->waktu);
                                                                            $bln = date("m", $time);
                                                                            $tahun = date("Y", $time);
                                ...
                                <div class="text-right">
                                    <!-- <div class="form-group"> -->
                                    <button onclick="window.location.href='<?php echo base_url('index.php/admin/printPDFPegawaiKTU/') . $dataPegawai[0]->emp_id . '/' . $dataPegawai[0]->waktu ?>'" class="btn btn-primary" id="btn_cetak"><i class="fas fa-print"></i> Cetak Laporan PNASN</button>
                                </div>
                                <hr>
                                <hr>
                            </div>
                            <table id="example1" class="table table-bordered table-striped responsive" width="100%">
                                ...
                                <tbody>
                                    ...
                                    foreach ($dataPegawai as $data) {
                                        ...
                                        $hari = strftime("%A", strtotime($data->waktu)) . "\n";
                                        $tanggal = strftime("%d %B %Y", strtotime($data->waktu)) . "\n";
                                        echo "<td>" . $hari . "</td>";
                                        echo "<td>" . $tanggal . "</td>";
                                        // $kegiatan = word_limiter($data->pelaksanaan_kegiatan, 20);
                                        echo "<td>" . $kegiatan . "</td>";
                                        // $keterangan = word_limiter($data->keterangan, 20);
                                        echo "<td>" . $keterangan . "</td>";
                                        echo "<td>" . $data->tindak_lanjut . "</td>";
                                        echo "<td>                                                  
                                                <a href='" . base_url('index.php/admin/LaporanPegawai/') . $data->lap_detail_id . "'
