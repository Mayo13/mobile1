                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <select class="custom-select">
                                <option>Direkotart Sistik</option>
                                <option>Direkotart Wasdakim</option>
                                <option>Direkotart Intelkim</option>
                                <option>Direkotart Intalkim</option>
                                <option>Direkotart Lanstaskim</option>
                                <option>Direkotart Kermakim0</option>
                            </select>
                        </div>
