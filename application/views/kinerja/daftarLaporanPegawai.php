        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Daftar Uraian Kinerja</h3>
                </div>
                <div class="card-body">
                    <!-- form biodata -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                            <h4 class="card-title" style="color: red;">Catatan :<br>
                                                * Periode laporan yang dapat dipilih maksimal 60 hari.<br>
                            ...
                            <table id="example3" class="table responive table-bordered table-striped">
                                <thead>
                                    <tr style="text-align: center;">
                                        <th style="vertical-align: middle; width: 15%;">Hari/Tanggal</th>
                                        <th style="vertical-align: middle; width: 20;">Jam Mulai</th>
                                        <th style="vertical-align: middle; width: 20;">Jam Selesai</th>
                                        <th style="vertical-align: middle; width: 60%;">Uraian Tugas</th>
                                        <th style="vertical-align: middle; width: 10%;">Terselesaikan</th>
                                    </tr>
                                </thead>
                                <tbody id="show_data">
                                </tbody>
            ...
            if (error > 0) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        console.log(data);
                        window.location.href = "<?php echo base_url('index.php/PenilaianKinerja/daftarLaporanPegawai') ?>"
